...
- Parameter of interest: mean price of the 1 bedroom apartments
...
We are 95% confident that the proportion of mice that died while not on the treatment is between .690 and .797.
...
We are 90% confident that the proportion of mice that lived while on treatment is between .552 and .651
